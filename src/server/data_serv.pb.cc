...
const uint32_t TableStruct_data_5fserv_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _split_
  ~0u,  // no sizeof(Split)
  PROTOBUF_FIELD_OFFSET(::dataserver::AddRequest, _impl_.server_name_),
  ...
  PROTOBUF_FIELD_OFFSET(::dataserver::GetRequest, _impl_.server_name_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::dataserver::DelRequest, _impl_.server_name_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 20, -1, -1, sizeof(::dataserver::GetResponse)},
  { 30, -1, -1, sizeof(::dataserver::GetRequest)},
  { 40, -1, -1, sizeof(::dataserver::DelResponse)},
  { 49, -1, -1, sizeof(::dataserver::DelRequest)},
  { 59, -1, -1, sizeof(::dataserver::DupRequest)},
  { 68, -1, -1, sizeof(::dataserver::DupResponse)},
  { 77, -1, -1, sizeof(::dataserver::ChangeMsRequest)},
  { 86, -1, -1, sizeof(::dataserver::ChangeMsResponse)},
  { 95, -1, -1, sizeof(::dataserver::DownGradeRequest)},
  { 103, -1, -1, sizeof(::dataserver::DownGradeResponse)},
  { 113, -1, -1, sizeof(::dataserver::UpGradeRequest)},
  { 121, -1, -1, sizeof(::dataserver::UpGradeResponse)},
  { 130, -1, -1, sizeof(::dataserver::Directory)},
  { 139, -1, -1, sizeof(::dataserver::Files)},
  { 149, -1, -1, sizeof(::dataserver::SyncFileRequest)},
  { 158, -1, -1, sizeof(::dataserver::SyncFileResponse)},
};
...
const char descriptor_table_protodef_data_5fserv_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ontents\030\003 \001(\014\"0\n\013GetResponse\022\017\n\007success\030"
  "\001 \001(\010\022\020\n\010contents\030\002 \001(\014\"4\n\nGetRequest\022\021\n"
  "\tfile_name\030\001 \001(\t\022\023\n\013server_name\030\002 \001(\t\"\036\n"
  "\013DelResponse\022\017\n\007success\030\001 \001(\010\"4\n\nDelRequ"
  "est\022\021\n\tfile_name\030\001 \001(\t\022\023\n\013server_name\030\002 "
  "\001(\t\"\036\n\nDupRequest\022\020\n\010contents\030\001 \001(\t\"\036\n\013D"
  "upResponse\022\017\n\007success\030\001 \001(\010\"%\n\017ChangeMsR"
  "equest\022\022\n\nslave_name\030\001 \003(\t\"#\n\020ChangeMsRe"
  "sponse\022\017\n\007success\030\001 \001(\010\"\022\n\020DownGradeRequ"
  "est\"2\n\021DownGradeResponse\022\017\n\007success\030\001 \001("
  "\010\022\014\n\004name\030\002 \001(\t\"\020\n\016UpGradeRequest\"\"\n\017UpG"
  "radeResponse\022\017\n\007success\030\001 \001(\010\"\036\n\tDirecto"
  "ry\022\021\n\tfile_name\030\001 \003(\t\"I\n\005Files\022\021\n\tfile_n"
  "ame\030\001 \003(\t\022-\n\016directory_name\030\002 \003(\0132\025.data"
  "server.Directory\"3\n\017SyncFileRequest\022 \n\005f"
  "iles\030\001 \001(\0132\021.dataserver.Files\"8\n\020SyncFil"
  "eResponse\022\021\n\tadd_files\030\001 \003(\t\022\021\n\tdel_file"
  "s\030\002 \003(\t2\211\004\n\013DataService\0226\n\003Add\022\026.dataser"
  "ver.AddRequest\032\027.dataserver.AddResponse\022"
  "6\n\003Get\022\026.dataserver.GetRequest\032\027.dataser"
  "ver.GetResponse\0226\n\003Del\022\026.dataserver.DelR"
  "equest\032\027.dataserver.DelResponse\0226\n\003Dup\022\026"
  ".dataserver.DupRequest\032\027.dataserver.DupR"
  "esponse\022E\n\010ChangeMs\022\033.dataserver.ChangeM"
  "sRequest\032\034.dataserver.ChangeMsResponse\022H"
  "\n\tDownGrade\022\034.dataserver.DownGradeReques"
  "t\032\035.dataserver.DownGradeResponse\022B\n\007UpGr"
  "ade\022\032.dataserver.UpGradeRequest\032\033.datase"
  "rver.UpGradeResponse\022E\n\010SyncFile\022\033.datas"
  "erver.SyncFileRequest\032\034.dataserver.SyncF"
  "ileResponseB\003\200\001\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_data_5fserv_2eproto = {
    false, false, 1344, descriptor_table_protodef_data_5fserv_2eproto,
    "data_serv.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "dataserver.AddRequest.server_name"));
        } else
          goto handle_unusual;
        continue;
      // string file_name = 2;
...
uint8_t* AddRequest::_InternalSerialize(
  ...
  if (!this->_internal_server_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "dataserver.AddRequest.server_name");
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "dataserver.GetRequest.server_name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* GetRequest::_InternalSerialize(
  ...
  if (!this->_internal_server_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_server_name().data(), static_cast<int>(this->_internal_server_name().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "dataserver.GetRequest.server_name");
    target = stream->WriteStringMaybeAliased(
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "dataserver.DelRequest.server_name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* DelRequest::_InternalSerialize(
  ...
  if (!this->_internal_server_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_server_name().data(), static_cast<int>(this->_internal_server_name().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "dataserver.DelRequest.server_name");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_server_name(), target);
  }
